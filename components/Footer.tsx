    ...
    <footer className="bg-gray-50 border-t border-gray-200 mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            <li><a href="https://wa.me/5551999999999" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900">WhatsApp</a></li>
        ...
        <div>
          ...
          <form className="flex flex-col gap-2">
            <input type="text" placeholder="Seu nome" className="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none" />
            <input type="email" placeholder="Seu e-mail" className="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none" />
            <button type="submit" className="bg-gray-900 text-white text-sm py-2 rounded hover:bg-gray-700 transition-colors">Já assinante</button>
          </form>
        </div>
        <div>
          ...
          <div className="text-sm text-gray-600 space-y-1">
            ...
            <a href="https://wa.me/555132312340" className="text-gray-800 hover:underline">51 32312340</a>
